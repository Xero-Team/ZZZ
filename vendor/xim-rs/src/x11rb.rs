...
#[cfg(feature = "x11rb-client")]
use crate::client::{
    ClientCore, ClientError, ClientHandler, handle_request as client_handle_request,
};
...
use x11rb::{
    ...
    protocol::{
        Event,
        xproto::{
            Atom, AtomEnum, CLIENT_MESSAGE_EVENT, ClientMessageEvent, ConnectionExt, KeyPressEvent,
