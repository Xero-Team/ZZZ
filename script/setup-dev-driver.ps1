...
$Volume = New-VHD -Path C:/zzz_dev_drive.vhdx -SizeBytes 100GB |
                    Mount-VHD -Passthru |
...
Dismount-VHD -Path C:/zzz_dev_drive.vhdx
Mount-VHD -Path C:/zzz_dev_drive.vhdx
