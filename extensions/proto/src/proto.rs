use zzz_extension_api::{self as zzz, Result, settings::LspSettings};
...
impl zzz::Extension for ProtobufExtension {
    fn new() -> Self {
        Self {
    ...
    fn language_server_command(
        &mut self,
        language_server_id: &zzz_extension_api::LanguageServerId,
        worktree: &zzz_extension_api::Worktree,
    ) -> zzz_extension_api::Result<zzz_extension_api::Command> {
    ...
    fn language_server_workspace_configuration(
        &mut self,
        server_id: &zzz::LanguageServerId,
...
zzz::register_extension!(ProtobufExtension);
