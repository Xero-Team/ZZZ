...
mod tests {
    ...
    fn default_and_known_model_helpers_match_expected_values() {
        ...
        assert_eq!(
            Model::from_id("gpt-5.6-sol").unwrap(),
            Model::FivePointSixSol
        );
        assert_eq!(
            Model::from_id("gpt-5.6-terra").unwrap(),
        ...
        assert!(Model::FivePointSixSol.uses_responses_api());
        assert!(Model::FivePointSixSol.supports_parallel_tool_calls());
    ...
    #[test]
    fn gpt_5_6_models_use_supported_reasoning_efforts() {
        let expected_efforts = [
            ReasoningEffort::None,
            ReasoningEffort::Low,
            ReasoningEffort::Medium,
        ...
        assert_eq!(
            Model::FivePointSixSol.supported_reasoning_efforts(),
            expected_efforts.as_slice()
        );
        assert_eq!(
            Model::FivePointSixTerra.supported_reasoning_efforts(),
            expected_efforts.as_slice()
        );
        assert_eq!(
            Model::FivePointSixLuna.supported_reasoning_efforts(),
            expected_efforts.as_slice()
        );
    }
