...
mod tests {
    ...
    fn test_duplicate_untracked_entries() {
        // Regression test for ZZZ-2XA: git can produce duplicate untracked entries
    ...
    fn test_tree_diff_parsing() {
        let input = ":000000 100644 0000000000000000000000000000000000000000 0062c311b8727c3a2e3cd7a41bc9904feacf8f98 A\x00.ZZZ/settings.json\x00".to_owned() +
        ...
        assert_eq!(
            ...
            TreeDiff {
                entries: [
                    (
                        RepoPath::new(".ZZZ/settings.json").unwrap(),
