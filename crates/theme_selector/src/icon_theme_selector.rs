...
impl PickerDelegate for IconThemeSelectorDelegate {
    ...
    fn placeholder_text(&self, _window: &mut Window, cx: &mut App) -> Arc<str> {
        tr(
            cx,
            "theme_selector.icon.placeholder",
            "Select Icon Theme...",
        )
        .into()
    }
        ...
        Some(
            h_flex()
                ...
                .child(
                    Button::new(
                        "docs",
                        tr(cx, "theme_selector.icon.view_docs", "View Icon Theme Docs"),
                    )
                    .end_icon(
                ...
                .child(
                    Button::new(
                        ...
                        tr(
                            cx,
                            "theme_selector.icon.install_themes",
                            "Install Icon Themes",
                        ),
                    )
...
mod tests {
    ...
    fn open_icon_theme_selector(
        ...
        cx.dispatch_action(zzz_actions::icon_theme_selector::Toggle {
            themes_filter: None,
        });
        cx.run_until_parked();
