...
///
/// With a count, Helix treats it as a 1-based line number and clamps to the
/// final line when the count exceeds the buffer length.
    ...
    pub fn helix_select_motion(
        ...
        self.update_editor(cx, |_, editor, cx| {
            ...
            editor.change_selections(Default::default(), window, cx, |s| {
                if let Motion::ZZZSearchResult { new_selections, .. } = &motion {
...
mod test {
    ...
    // Regression test for ZZZ-758: helix motions called
