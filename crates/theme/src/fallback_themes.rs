...
/// The default theme family for ZZZ.
///
...
pub fn zzz_default_themes() -> ThemeFamily {
    ThemeFamily {
        id: "zzz-default".to_owned(),
        name: "ZZZ Default".into(),
        author: "".into(),
        themes: vec![zzz_default_dark()],
...
pub(crate) fn zzz_default_dark() -> Theme {
