...
impl ProjectEnvironment {
    ...
    /// Returns the inherited CLI environment, if this project was opened from the ZZZ CLI.
...
fn set_origin_marker(env: &mut HashMap<String, String>, origin: EnvironmentOrigin) {
    env.insert(ZZZ_ENVIRONMENT_ORIGIN_MARKER.to_owned(), origin.into());
}

const ZZZ_ENVIRONMENT_ORIGIN_MARKER: &str = "ZZZ_ENVIRONMENT";
