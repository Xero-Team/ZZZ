...
mod git_worktrees {
    ...
    fn test_validate_worktree_directory() {
        ...
        // Valid: subdirectory
        assert!(
            worktrees_directory_for_repo(work_dir, ".git/zzz-worktrees", PathStyle::Posix).is_ok()
        );
...
mod resolve_worktree_tests {
    ...
    fn test_linked_worktree_short_name() {
        let examples = [
            (
                "/home/bob/zzz",
                "/home/bob/worktrees/olivetti/zzz",
                Some("olivetti".into()),
            ),
            ("/home/bob/zzz", "/home/bob/zzz2", Some("zzz2".into())),
            (
                "/home/bob/zzz",
                "/home/bob/worktrees/zzz/selectric",
                Some("selectric".into()),
            ),
            ("/home/bob/zzz", "/home/bob/zzz", None),
        ];
