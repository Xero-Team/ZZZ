...
const PYTHON_ACTIVE_TOOLCHAIN_PATH: VariableName =
    VariableName::Custom(Cow::Borrowed("PYTHON_ACTIVE_ZZZ_TOOLCHAIN"));
        ...
        tasks.extend(match test_runner {
            TestRunner::UNITTEST => {
                [
                    ...
                    TaskTemplate {
                        label: "unittest $ZZZ_CUSTOM_PYTHON_TEST_TARGET".to_owned(),
                        command: PYTHON_ACTIVE_TOOLCHAIN_PATH.template_value(),
                        args: vec![
                            "-m".to_owned(),
                            "unittest".to_owned(),
            ...
            TestRunner::PYTEST => {
                [
                    ...
                    // Run test(s) for a specific target within a file
                    TaskTemplate {
                        label: "pytest $ZZZ_CUSTOM_PYTHON_TEST_TARGET".to_owned(),
                        command: PYTHON_ACTIVE_TOOLCHAIN_PATH.template_value(),
                        args: vec![
                            "-m".to_owned(),
                            "pytest".to_owned(),
...
mod tests {
    ...
    async fn test_conda_activation_skips_unquotable_name(cx: &mut TestAppContext) {
        ...
        assert!(
            !script.iter().any(|line| line.contains("conda activate")),
