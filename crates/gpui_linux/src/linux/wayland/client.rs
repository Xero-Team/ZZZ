...
use crate::linux::{
    ...
    wayland::{
        clipboard::{
            Clipboard, DataOffer, FILE_LIST_MIME_TYPE, HTML_MIME_TYPE, PLAIN_TEXT_MIME_TYPES,
        },
        cursor::Cursor,
        ...
        match event {
            ...
            zwp_text_input_v3::Event::CommitString { text } => {
                ...
                if let Some(commit_text) = text {
                    ...
                    // We should only send ASCII characters to ZZZ, otherwise a user could remap a letter like `か` or `相`.
