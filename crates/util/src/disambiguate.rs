...
mod tests {
    ...
    fn test_duplicate_paths_from_multiple_groups() {
        ...
        // Simulates the sidebar scenario: a path like /Users/rtfeldman/code/zzz
        // appears in two project groups (e.g. "zzz" alone and "zzz, roc").
        // After deduplication, only unique paths should be disambiguated.
        //
        // Paths:
        //   /Users/rtfeldman/code/worktrees/zzz/focal-arrow/zzz  (group 1)
        //   /Users/rtfeldman/code/zzz                             (group 2)
        //   /Users/rtfeldman/code/zzz                             (group 3, same path as group 2)
        //   /Users/rtfeldman/code/roc                             (group 3)
        //
        // A naive flat_map collects duplicates. The duplicate /code/zzz entries
        ...
        let all_paths: Vec<&Path> = vec![
            Path::new("/Users/rtfeldman/code/worktrees/zzz/focal-arrow/zzz"),
            Path::new("/Users/rtfeldman/code/zzz"),
        ...
        // focal-arrow/zzz and code/zzz both end in "zzz", so they need detail 1.
        // "roc" is unique at detail 0.
        assert_eq!(details, vec![1, 1, 0]);

        assert_eq!(path_suffix(all_paths[0], details[0]), "focal-arrow/zzz");
        assert_eq!(path_suffix(all_paths[1], details[1]), "code/zzz");
