...
pub fn get_windows_system_shell() -> String {
    #[cfg(windows)]
    {
        ...
        return get_powershell().unwrap_or_else(|| (*CMD).clone());
    }
...
mod tests {
    ...
    // wsl.exe --distribution NixOS --cd ~ env RUST_LOG=info,remote=debug .zzz_wsl_server/zzz-remote-server-dev-build proxy --identifier dev-workspace-53
