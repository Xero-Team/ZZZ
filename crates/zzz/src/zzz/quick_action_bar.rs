                        ...
                        .when(!is_deployed, |this| {
                            this.when(has_available_code_actions, |this| {
                                this.tooltip(Tooltip::for_action_title(
                                    tr(cx, "zzz.quick_action_bar.code_actions", "Code Actions"),
                            ...
                            .when(
                                ...
                                |this| {
                                    this.tooltip(Tooltip::for_action_title(
                                        tr(
                                            cx,
                                            "zzz.quick_action_bar.no_code_actions_available",
        ...
        let editor_selections_dropdown = selection_menu_enabled.then(|| {
            ...
            PopoverMenu::new("editor-selections-dropdown")
                .trigger_with_tooltip(
                    ...
                    Tooltip::text(tr(
                        cx,
                        "zzz.quick_action_bar.selection_controls",
                        "Selection Controls",
                    )),
                )
                ...
                .menu(move |window, cx| {
                    ...
                    let select_all = tr(cx, "zzz.quick_action_bar.select_all", "Select All");
                    let select_next_occurrence = tr(
                        cx,
                        "zzz.quick_action_bar.select_next_occurrence",
                        "Select Next Occurrence",
                    );
                    let expand_selection = tr(
                        cx,
                        "zzz.quick_action_bar.expand_selection",
                        "Expand Selection",
                    );
                    let shrink_selection = tr(
                        cx,
                        "zzz.quick_action_bar.shrink_selection",
                        "Shrink Selection",
                    );
                    let add_cursor_above = tr(
                        cx,
                        "zzz.quick_action_bar.add_cursor_above",
                        "Add Cursor Above",
                    );
                    let add_cursor_below = tr(
                        cx,
                        "zzz.quick_action_bar.add_cursor_below",
                        "Add Cursor Below",
                    );
                    ...
                    let go_to_symbol = tr(cx, "zzz.quick_action_bar.go_to_symbol", "Go to Symbol");
                    let go_to_line_column = tr(
                        cx,
                        "zzz.quick_action_bar.go_to_line_column",
                        "Go to Line/Column",
                    );
                    let next_problem = tr(cx, "zzz.quick_action_bar.next_problem", "Next Problem");
                    let previous_problem = tr(
                        cx,
                        "zzz.quick_action_bar.previous_problem",
                        "Previous Problem",
                    );
                    let next_hunk = tr(cx, "zzz.quick_action_bar.next_hunk", "Next Hunk");
                    let previous_hunk =
                        tr(cx, "zzz.quick_action_bar.previous_hunk", "Previous Hunk");
                    let move_line_up = tr(cx, "zzz.quick_action_bar.move_line_up", "Move Line Up");
                    let move_line_down =
                        tr(cx, "zzz.quick_action_bar.move_line_down", "Move Line Down");
                    let duplicate_selection = tr(
                        cx,
                        "zzz.quick_action_bar.duplicate_selection",
                        "Duplicate Selection",
                    );
        ...
        let editor_settings_dropdown = {
            ...
            PopoverMenu::new("editor-settings")
                .trigger_with_tooltip(
                    ...
                    Tooltip::text(tr(
                        cx,
                        "zzz.quick_action_bar.editor_controls",
                        "Editor Controls",
                    )),
                )
                .anchor(Anchor::TopRight)
                ...
                .menu(move |window, cx| {
                    ...
                    let inlay_hints =
                        tr(cx, "zzz.quick_action_bar.inlay_hints", "Inlay Hints");
                    let inline_values =
                        tr(cx, "zzz.quick_action_bar.inline_values", "Inline Values");
                    let semantic_highlights = tr(
                        cx,
                        "zzz.quick_action_bar.semantic_highlights",
                        "Semantic Highlights",
                    );
                    let code_lens = tr(cx, "zzz.quick_action_bar.code_lens", "Code Lens");
                    let minimap = tr(cx, "zzz.quick_action_bar.minimap", "Minimap");
                    let edit_predictions = tr(
                        cx,
                        "zzz.quick_action_bar.edit_predictions",
                        "Edit Predictions",
                    );
                    let edit_predictions_unavailable = tr(
                        cx,
                        "zzz.quick_action_bar.edit_predictions_unavailable",
                        "You can't toggle edit predictions for this file as it is within the excluded files list.",
                    );
                    let diagnostics =
                        tr(cx, "zzz.quick_action_bar.diagnostics", "Diagnostics");
                    let inline_diagnostics = tr(
                        cx,
                        "zzz.quick_action_bar.inline_diagnostics",
                        "Inline Diagnostics",
                    );
                    let inline_diagnostics_unavailable = tr(
                        cx,
                        "zzz.quick_action_bar.inline_diagnostics_unavailable",
                        "Inline diagnostics are not available until regular diagnostics are enabled.",
                    );
                    let line_numbers =
                        tr(cx, "zzz.quick_action_bar.line_numbers", "Line Numbers");
                    let selection_menu =
                        tr(cx, "zzz.quick_action_bar.selection_menu", "Selection Menu");
                    let auto_signature_help = tr(
                        cx,
                        "zzz.quick_action_bar.auto_signature_help",
                        "Auto Signature Help",
                    );
                    let inline_git_blame = tr(
                        cx,
                        "zzz.quick_action_bar.inline_git_blame",
                        "Inline Git Blame",
                    );
                    let column_git_blame = tr(
                        cx,
                        "zzz.quick_action_bar.column_git_blame",
                        "Column Git Blame",
                    );
                    let vim_mode = tr(cx, "zzz.quick_action_bar.vim_mode", "Vim Mode");
                    let helix_mode = tr(cx, "zzz.quick_action_bar.helix_mode", "Helix Mode");
