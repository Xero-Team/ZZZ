...
//! Visual testing infrastructure for ZZZ.
//!
//! This module provides utilities for visual regression testing of ZZZ's UI.
//! It allows capturing screenshots of the real ZZZ application window and comparing
...
//! cargo test -p zzz visual_tests -- --ignored --test-threads=1
//!
//! # Update baselines when UI intentionally changes
//! UPDATE_BASELINES=1 cargo test -p zzz visual_tests -- --ignored --test-threads=1
//! ```
//!
//! ## Screenshot Output
//!
...
mod tests {
    ...
    /// This test captures a screenshot of an empty ZZZ workspace.
    ///
