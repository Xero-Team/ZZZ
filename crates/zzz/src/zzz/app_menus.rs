...
pub fn app_menus(cx: &mut App) -> Vec<Menu> {
    use zzz_actions::Quit;

    let mut view_items = vec![
        MenuItem::action(
            tr(cx, "menu.view.zoom_in", "Zoom In"),
            zzz_actions::IncreaseBufferFontSize { persist: false },
        ),
        MenuItem::action(
            tr(cx, "menu.view.zoom_out", "Zoom Out"),
            zzz_actions::DecreaseBufferFontSize { persist: false },
        ),
        MenuItem::action(
            tr(cx, "menu.view.reset_zoom", "Reset Zoom"),
            zzz_actions::ResetBufferFontSize { persist: false },
        ),
        MenuItem::action(
            tr(cx, "menu.view.reset_all_zoom", "Reset All Zoom"),
            zzz_actions::ResetAllZoom { persist: false },
        ),
        MenuItem::separator(),
        MenuItem::action(
        ...
        MenuItem::action(
            ...
            zzz_actions::project_panel::ToggleFocus,
        ),
        MenuItem::action(
            ...
            items: vec![
                ...
                MenuItem::submenu(Menu::new(tr(cx, "menu.settings", "Settings")).items([
                    ...
                    MenuItem::action(
                        ...
                        zzz_actions::OpenProjectSettings,
                    ),
                    MenuItem::action(
                        tr(
                            cx,
                    ...
                    MenuItem::action(
                        ...
                        zzz_actions::theme_selector::Toggle::default(),
                    ),
                    MenuItem::action(
                        tr(
                            cx,
                        ...
                        zzz_actions::icon_theme_selector::Toggle::default(),
                    ),
                ])),
                MenuItem::separator(),
                #[cfg(target_os = "macos")]
                ...
                MenuItem::action(
                    ...
                    zzz_actions::Extensions::default(),
                ),
        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::action(
                    ...
                    zzz_actions::OpenRemote::default(),
                ),
                MenuItem::separator(),
                MenuItem::action(
        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::action(
                    ...
                    zzz_actions::command_palette::Toggle,
                ),
                MenuItem::separator(),
                MenuItem::action(
        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::action(
                    ...
                    crate::zzz::OpenProjectTasks,
                ),
                MenuItem::action(
                    tr(cx, "menu.run.edit_debug_json", "Edit debug.json..."),
                    zzz_actions::OpenProjectDebugTasks,
                ),
                MenuItem::separator(),
                MenuItem::action(
        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::action(
                    ...
                    zzz_actions::feedback::FileBugReport,
                ),
                MenuItem::action(
                    tr(cx, "menu.help.request_feature", "Request Feature..."),
                    zzz_actions::feedback::RequestFeature,
                ),
                MenuItem::separator(),
                MenuItem::action(
                    tr(cx, "menu.help.zzz_repository", "ZZZ Repository"),
                    feedback::OpenZZZRepo,
                ),
            ],
        },
    ]
