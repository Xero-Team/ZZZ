...
//! of real ZZZ windows and compares them against baseline images.
//!
...
#[cfg(target_os = "macos")]
fn main() {
    // Set ZZZ_STATELESS early to prevent file system access to real config directories
    // This must be done before any code accesses zzz_env_vars::ZZZ_STATELESS
    // SAFETY: We're at the start of main(), before any threads are spawned
    unsafe {
        std::env::set_var("ZZZ_STATELESS", "1");
    }
...
mod constants {
    ...
    pub const BASELINE_DIR: &str = "crates/zzz/test_fixtures/visual_tests";

    /// Embedded test image (ZZZ app icon) for visual tests.
...
fn run_visual_tests(project_path: PathBuf, update_baseline: bool) -> Result<()> {
    ...
    // Test settings use Courier font, but we want the real ZZZ fonts for visual tests
    cx.update(|cx| {
        settings::init(cx);
    });
...
This is a test project for visual testing of ZZZ.
                    ...
                    if let Some(prompt_editor) = editor.diff_review_prompt_editor().cloned() {
                        prompt_editor.update(cx, |prompt_editor: &mut editor::Editor, cx| {
                            prompt_editor.insert(
                                &tr(
                                    cx,
                                    "zzz.visual_test_runner.diff_review.better_error_handling",
                    ...
                    if let Some(prompt_editor) = editor.diff_review_prompt_editor().cloned() {
                        prompt_editor.update(cx, |pe, cx| {
                            pe.insert(
                                &tr(
                                    cx,
                                    "zzz.visual_test_runner.diff_review.second_comment_about_imports",
                    ...
                    if let Some(prompt_editor) = editor.diff_review_prompt_editor().cloned() {
                        prompt_editor.update(cx, |pe, cx| {
                            pe.insert(
                                &tr(
                                    cx,
                                    "zzz.visual_test_runner.diff_review.third_comment_about_naming_conventions",
...
fn run_agent_thread_view_test(
    ...
    let read_file_label = cx.read(|app| {
        tr(
            app,
            "zzz.visual_test_runner.agent_thread.read_file",
    ...
    let send_future = thread.update(cx, |thread, cx| {
        thread.send(
            vec![
                tr(
                    cx,
                    "zzz.visual_test_runner.agent_thread.show_zzz_logo",
                    "Show me the ZZZ logo",
                )
                .into(),
            ],
            cx,
...
fn run_tool_permissions_visual_tests(
    ...
    use zzz_actions::OpenSettingsAt;
...
fn run_multi_workspace_sidebar_visual_tests(
    ...
    let workspace2_dir = canonical_temp.join("zzz");
            ...
            for (index, workspace) in workspaces.iter().enumerate() {
                ...
                let (session_id, title, updated_at) = match index {
                    0 => (
                        ...
                        tr(
                            cx,
                            "zzz.visual_test_runner.multi_workspace.refine_thread_view_scrolling_behavior",
                    ...
                    1 => (
                        ...
                        tr(
                            cx,
                            "zzz.visual_test_runner.multi_workspace.add_line_numbers_option",
...
impl gpui::Render for ErrorWrappingTestView {
    fn render(
        ...
        let retry_description = tr(
            cx,
            "zzz.visual_test_runner.callout.retrying",
        ...
        v_flex()
            ...
            .child(
                Callout::new()
                    ...
                    .title(tr(
                        cx,
                        "zzz.visual_test_runner.callout.error_happened",
                        "An Error Happened",
                    ))
                    ...
                    .actions_slot(
                        Button::new(
                            "dismiss",
                            tr(cx, "zzz.visual_test_runner.common.dismiss", "Dismiss"),
                        )
            ...
            .child(
                Callout::new()
                    ...
                    .actions_slot(
                        Button::new(
                            "retry",
                            tr(cx, "zzz.visual_test_runner.common.retry", "Retry"),
                        )
                        .label_size(LabelSize::Small),
                    ),
            )
    ...
    fn render(
        ...
        v_flex()
            ...
            .child(
                Label::new(tr(
                    cx,
                    "zzz.visual_test_runner.thread_item_branch_names.title",
            ...
            .child(section_label(tr(
                cx,
                "zzz.visual_test_runner.thread_item_branch_names.linked_worktree_with_branch",
            ...
            .child(
                container().child(
                    ThreadItem::new(
                        ...
                        tr(
                            cx,
                            "zzz.visual_test_runner.thread_item_branch_names.fix_scrolling_behavior",
                        ...
                        .worktrees(vec![ThreadItemWorktreeInfo {
                            ...
                            full_path: "/worktrees/jade-glen/zzz".into(),
            ...
            .child(section_label(tr(
                cx,
                "zzz.visual_test_runner.thread_item_branch_names.linked_worktree_without_branch",
            ...
            .child(
                container().child(
                    ThreadItem::new(
                        ...
                        tr(
                            cx,
                            "zzz.visual_test_runner.thread_item_branch_names.review_worktree_cleanup",
                        ...
                        .worktrees(vec![ThreadItemWorktreeInfo {
                            ...
                            full_path: "/worktrees/focal-arrow/zzz".into(),
                            highlight_positions: Vec::new(),
                            kind: WorktreeKind::Linked,
                            branch_name: None,
                        }]),
            ...
            .child(section_label(tr(
                cx,
                "zzz.visual_test_runner.thread_item_branch_names.main_worktree_with_branch",
            ...
            .child(
                container().child(
                    ThreadItem::new(
                        ...
                        tr(
                            cx,
                            "zzz.visual_test_runner.thread_item_branch_names.request_for_long_classic_poem",
                            "Request for Long Classic Poem",
                        ),
                    )
                        .icon(IconName::ZZZAgent)
                        .timestamp("2d")
                        .worktrees(vec![ThreadItemWorktreeInfo {
                            worktree_name: Some("zzz".into()),
                            full_path: "/projects/zzz".into(),
                            highlight_positions: Vec::new(),
            ...
            .child(section_label(tr(
                cx,
                "zzz.visual_test_runner.thread_item_branch_names.main_worktree_without_branch",
            ...
            .child(
                container().child(
                    ThreadItem::new(
                        ...
                        tr(
                            cx,
                            "zzz.visual_test_runner.thread_item_branch_names.simple_greeting_thread",
            ...
            .child(section_label(tr(
                cx,
                "zzz.visual_test_runner.thread_item_branch_names.linked_worktree_name_matches_branch",
            ...
            .child(
                container().child(
                    ThreadItem::new(
                        ...
                        tr(
                            cx,
                            "zzz.visual_test_runner.thread_item_branch_names.implement_feature",
                            "Implement feature",
                        ),
                    )
                        .icon(IconName::AiClaude)
                        ...
                        .worktrees(vec![ThreadItemWorktreeInfo {
                            ...
                            full_path: "/worktrees/stoic-reed/zzz".into(),
                            highlight_positions: Vec::new(),
                            kind: WorktreeKind::Linked,
            ...
            .child(section_label(tr(
                cx,
                "zzz.visual_test_runner.thread_item_branch_names.manually_opened_linked_worktree",
            ...
            .child(
                container().child(
                    ThreadItem::new(
                        ...
                        tr(
                            cx,
                            "zzz.visual_test_runner.thread_item_branch_names.robust_git_worktree_rollback",
            ...
            .child(section_label(tr(
                cx,
                "zzz.visual_test_runner.thread_item_branch_names.linked_worktree_full_metadata",
            ...
            .child(
                container().child(
                    ThreadItem::new(
                        ...
                        tr(
                            cx,
                            "zzz.visual_test_runner.thread_item_branch_names.full_metadata_with_diff_stats",
            ...
            .child(section_label(tr(
                cx,
                "zzz.visual_test_runner.thread_item_branch_names.long_branch_name_truncation",
            ...
            .child(
                container().child(
                    ThreadItem::new(
                        ...
                        tr(
                            cx,
                            "zzz.visual_test_runner.thread_item_branch_names.overflow_test_long_branch",
                        ...
                        .worktrees(vec![ThreadItemWorktreeInfo {
                            ...
                            full_path: "/worktrees/my-project/zzz".into(),
                            highlight_positions: Vec::new(),
                            kind: WorktreeKind::Linked,
                            branch_name: Some(
            ...
            .child(section_label(tr(
                cx,
                "zzz.visual_test_runner.thread_item_branch_names.main_worktree_full_metadata",
            ...
            .child(
                container().child(
                    ThreadItem::new(
                        ...
                        tr(
                            cx,
                            "zzz.visual_test_runner.thread_item_branch_names.main_worktree_with_everything",
    ...
    fn render(
        ...
        v_flex()
            ...
            .child(
                Label::new(tr(
                    cx,
                    "zzz.visual_test_runner.thread_item_icon_decorations.title",
            ...
            .child(section_label(tr(
                cx,
                "zzz.visual_test_runner.thread_item_icon_decorations.no_decoration",
            ...
            .child(
                container().child(
                    ThreadItem::new(
                        ...
                        tr(
                            cx,
                            "zzz.visual_test_runner.thread_item_icon_decorations.default_idle_thread",
                            "Default idle thread",
                        ),
                    )
                    .timestamp("1:00 AM"),
            ...
            .child(section_label(tr(
                cx,
                "zzz.visual_test_runner.thread_item_icon_decorations.blue_dot",
                "Blue dot (notified)",
            )))
            .child(
                container().child(
                    ThreadItem::new(
                        ...
                        tr(
                            cx,
                            "zzz.visual_test_runner.thread_item_icon_decorations.generation_completed_successfully",
            ...
            .child(section_label(tr(
                cx,
                "zzz.visual_test_runner.thread_item_icon_decorations.yellow_triangle",
            ...
            .child(
                container().child(
                    ThreadItem::new(
                        ...
                        tr(
                            cx,
                            "zzz.visual_test_runner.thread_item_icon_decorations.waiting_for_user_confirmation",
            ...
            .child(section_label(tr(
                cx,
                "zzz.visual_test_runner.thread_item_icon_decorations.red_x",
                "Red X (error)",
            )))
            .child(
                container().child(
                    ThreadItem::new(
                        ...
                        tr(
                            cx,
                            "zzz.visual_test_runner.thread_item_icon_decorations.failed_to_connect_to_server",
            ...
            .child(section_label(tr(
                cx,
                "zzz.visual_test_runner.thread_item_icon_decorations.spinner",
                "Spinner (running)",
            )))
            .child(
                container().child(
                    ThreadItem::new(
                        ...
                        tr(
                            cx,
                            "zzz.visual_test_runner.thread_item_icon_decorations.generating_response",
                            "Generating response...",
                        ),
                    )
                        .icon(IconName::AiClaude)
            ...
            .child(section_label(tr(
                cx,
                "zzz.visual_test_runner.thread_item_icon_decorations.spinner_with_yellow_triangle",
            ...
            .child(
                container().child(
                    ThreadItem::new(
                        ...
                        tr(
                            cx,
                            "zzz.visual_test_runner.thread_item_icon_decorations.running_but_needs_confirmation",
...
fn run_sidebar_duplicate_project_names_visual_tests(
    ...
    // Create directory structure where every leaf directory is named "zzz" but
    ...
    //
    //   code/zzz/       — project1 (single worktree)
    //   code/foo/zzz/   — project2 (single worktree)
    //   code/bar/zzz/   — project3, first worktree
    //   code/baz/zzz/   — project3, second worktree
    //
    // No two projects share a worktree path, so ProjectGroupBuilder will
    // place each in its own group.
    let code_zzz = canonical_temp.join("code").join("zzz");
    let foo_zzz = canonical_temp.join("code").join("foo").join("zzz");
    let bar_zzz = canonical_temp.join("code").join("bar").join("zzz");
    let baz_zzz = canonical_temp.join("code").join("baz").join("zzz");
    std::fs::create_dir_all(&code_zzz)?;
    std::fs::create_dir_all(&foo_zzz)?;
    std::fs::create_dir_all(&bar_zzz)?;
    std::fs::create_dir_all(&baz_zzz)?;
    ...
    // Two single-worktree projects whose leaf name is "zzz"
    {
        let project1 = create_project_with_worktree(&code_zzz, &app_state, cx)?;
        let project2 = create_project_with_worktree(&foo_zzz, &app_state, cx)?;
    ...
    // Three projects, third has two worktrees (all leaf names "zzz")
    //
    // project1: code/zzz
    // project2: code/foo/zzz
    // project3: code/bar/zzz + code/baz/zzz
    //
    ...
    // separate groups. The sidebar must disambiguate all three.
    {
        ...
        let project3 = create_project_with_worktree(&bar_zzz, &app_state, cx)?;
        let add_second_worktree = cx.update(|cx| {
            project3.update(cx, |project, cx| {
                project.find_or_create_worktree(&baz_zzz, true, cx)
            })
        });
        cx.background_executor.allow_parking();
        cx.foreground_executor
