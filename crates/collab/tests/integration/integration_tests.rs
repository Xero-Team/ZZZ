...
async fn test_local_settings(
    ...
    client_a
        .fs()
        .insert_file("/dir/.ZZZ/settings.json", r#"{}"#.into())
        .await;
    executor.run_until_parked();
    cx_b.read(|cx| {
        let store = cx.global::<SettingsStore>();
    ...
    client_a
        .fs()
        .remove_file("/dir/.ZZZ/settings.json".as_ref(), Default::default())
        .await
        .unwrap();
    client_a
        .fs()
    ...
    client_a
        .fs()
        .insert_file("/dir/b/.ZZZ/settings.json", r#"{"tab_size": 4}"#.into())
        .await;
    executor.run_until_parked();
    cx_b.read(|cx| {
        let store = cx.global::<SettingsStore>();
    ...
    client_a
        .fs()
        .insert_file("/dir/a/.ZZZ/settings.json", r#"{"hard_tabs":true}"#.into())
        .await;
    client_a
        .fs()
        .remove_file("/dir/b/.ZZZ/settings.json".as_ref(), Default::default())
        .await
        .unwrap();
    executor.run_until_parked();
