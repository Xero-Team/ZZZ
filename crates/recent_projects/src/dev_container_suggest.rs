            ...
            workspace.update_in(cx, |workspace, window, cx| {
                ...
                if has_configs {
                    cx.on_next_frame(window, move |_workspace, window, cx| {
                        window.dispatch_action(Box::new(zzz_actions::OpenDevContainer), cx);
                    });
                } else {
        ...
        workspace.show_notification(notification_id, cx, |cx| {
            cx.new(move |cx| {
                let message: SharedString = tr(
                    ...
                    "{} contains a Dev Container configuration file. Would you like to re-open it in a container?",
                )
                ...
                .secondary_message(tr(
                    cx,
                    "recent_projects.dev_container_suggest.dont_show_again",
                    "Don't Show Again",
                ))
