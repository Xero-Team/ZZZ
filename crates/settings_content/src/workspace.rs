...
pub struct WorkspaceSettingsContent {
    ...
    /// Controls whether ZZZ or the window manager or compositor draws window decorations on Linux.
    ///
    /// Default: client
...
pub enum WindowDecorations {
    /// ZZZ draws its own window decorations/titlebar (client-side decoration).
    #[default]
    Client,
