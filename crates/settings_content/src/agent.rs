...
pub struct AgentSettingsContent {
    ...
    /// external agent's permission system is only used when ZZZ would allow
...
pub enum CustomAgentServerSettings {
    ...
    // Used for ACP extension migration.
...
mod tests {
    ...
    fn agent_config_option_value_serializes_value_id_as_string() {
        ...
        assert_eq!(
            ...
            AgentConfigOptionValue::ValueId("manual".to_owned())
        );
    }
    ...
    fn agent_config_option_value_merge_replaces_existing_value() {
        ...
        let mut value = AgentConfigOptionValue::ValueId("manual".to_owned());
