...
pub struct LspSettings {
    ...
    /// this setting can be used to enable or disable them in ZZZ.
    /// Default: true
...
pub struct GitSettings {
    ...
    /// `"../worktrees"` and a project at `~/code/zzz`, worktrees are
    /// created under `~/code/worktrees/zzz/`.
    ///
    ...
    /// - `".git/zzz-worktrees"` — `<project>/.git/zzz-worktrees/`
