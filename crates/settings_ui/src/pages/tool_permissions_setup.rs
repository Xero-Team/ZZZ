...
const SETTINGS_DISCLAIMER: &str = "Note: custom tool permissions apply to all agents in Zed, including external agents connected through the Agent Client Protocol (ACP).";
