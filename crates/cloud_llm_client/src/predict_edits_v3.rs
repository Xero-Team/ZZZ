...
pub const PREDICT_EDITS_MODE_HEADER_NAME: &str = "X-ZZZ-Predict-Edits-Mode";
pub const PREDICT_EDITS_REQUEST_ID_HEADER_NAME: &str = "X-ZZZ-Predict-Edits-Request-Id";
pub const PREDICT_EDITS_TRIGGER_HEADER_NAME: &str = "X-ZZZ-Predict-Edits-Trigger";
