    ...
    impl Render for TestElicitationView {
        fn render(&mut self, _window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
            ...
            div()
                ...
                .on_action(|_: &zzz_actions::agent::Chat, _, _| {
...
impl Component for ElicitationCardPreview {
    ...
    fn description() -> Option<&'static str> {
        Some("ACP elicitation request cards as rendered in the agent panel.")
    }
...
fn render_form_preview(
    ...
    let request = acp::CreateElicitationRequest::new(
        ...
        "Choose how ZZZ should connect to this account.",
    );
...
fn render_url_preview(
    ...
    let request = acp::CreateElicitationRequest::new(
        ...
        "Authorize ZZZ in your browser to finish signing in.",
    );
