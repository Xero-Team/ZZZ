...
use zzz_actions::agent::{Chat, PasteRaw};
...
mod tests {
    ...
    fn test_parse_mention_links() {
        // Single file mention
        let text = "[@bundle-mac](file:///Users/test/zzz/script/bundle-mac)";
    ...
    fn write_test_png_file(extension: Option<&str>) -> PathBuf {
        ...
        let file_name = match extension {
            Some(extension) => format!("zzz-agent-ui-test-{}.{}", uuid::Uuid::new_v4(), extension),
            None => format!("zzz-agent-ui-test-{}", uuid::Uuid::new_v4()),
        };
