...
Icons are a big part of ZZZ, and they're how we convey hundreds of actions without relying on labeled buttons.
...
Then, they're modified, adjusted, cleaned up, and simplified depending on their use and overall fit with ZZZ.
...
Make sure to tag a member of ZZZ's design team so we can review and adjust any newly introduced icon.
