    ...
    const MIGRATIONS: &[&str] = &[
        sql!(
            CREATE TABLE workspaces(
                ...
                dock_visible INTEGER, // Deprecated. Preserving so users can downgrade ZZZ.
                dock_anchor TEXT, // Deprecated. Preserving so users can downgrade ZZZ.
                dock_pane INTEGER, // Deprecated.  Preserving so users can downgrade ZZZ.
        ...
        // Preserving so users can downgrade ZZZ.
        sql!(
...
impl WorkspaceDb {
    ...
    // session was closed (i.e. when ZZZ was quit).
