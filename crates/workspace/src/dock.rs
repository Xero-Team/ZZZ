...
pub trait Panel: Focusable + EventEmitter<PanelEvent> + Render + Sized {
    ...
    /// Returns the descendant that should receive focus when the panel is activated.
    ///
    /// `Focusable::focus_handle` identifies the stable panel root for containment checks.
