                ...
                .children(vec![
                    example_group_with_title(
                        ...
                        vec![
                            single_example(
                                "Default",
                                Vector::square(VectorName::ZZZLogo, size).into_any_element(),
                            ),
                            single_example(
                                "Custom Size",
                                h_flex()
                    ...
                    example_group_with_title(
                        ...
                        vec![
                            single_example(
                                "Accent Color",
                                Vector::square(VectorName::ZZZLogo, size)
                                    .color(Color::Accent)
                                    .into_any_element(),
                            ),
                            single_example(
                    ...
                    example_group_with_title(
                        ...
                        vec![single_example(
                            "ZZZ X Copilot",
                            Vector::square(VectorName::ZZZXCopilot, rems_from_px(100.))
                                .into_any_element(),
                        )],
                    ),
                ])
...
mod tests {
    ...
    #[test]
    fn vector_path() {
        assert_eq!(VectorName::ZZZLogo.path().as_ref(), "images/zzz_logo.svg");
    }
}
