...
mod tests {
    ...
    fn test_parse_backtick_spans_single_span() {
        let (text, ranges) = parse_backtick_spans("use `zzz` to open").unwrap();
        assert_eq!(text.as_ref(), "use zzz to open");
                ...
                .children(vec![
                    example_group_with_title(
                        ...
                        vec![
                            ...
                            single_example("Large", Label::new("Welcome to ZZZ").size(LabelSize::Large).into_any_element()),
                        ],
                    ),
                    example_group_with_title(
                        "Colors",
                    ...
                    example_group_with_title(
                        ...
                        vec![
                            ...
                            single_example("Start Truncation", div().max_w_24().child(Label::new("zzz/crates/ui/src/components/label/truncate/label/label.rs").truncate_start()).into_any_element()),
                        ],
                    ),
                ])
                .into_any_element()
