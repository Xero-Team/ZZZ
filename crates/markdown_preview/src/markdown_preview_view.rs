                        ...
                        let content = right_click_menu("markdown-preview-context-menu")
                            ...
                            .maybe_menu(move |window, cx| {
                                ...
                                let selected_markdown =
                                    markdown_state.context_menu_selected_markdown().cloned();
...
impl SearchableItem for MarkdownPreviewView {
    ...
    fn find_matches(
        ...
        let source = markdown.source().to_owned();
...
mod tests {
    ...
    use editor::Editor;
    use gpui::{AppContext, Entity, Focusable as _, TestAppContext, WindowHandle};
    use image::ImageEncoder as _;
    ...
    use super::{
        ImageSource, MarkdownPreviewView, Resource, filter_non_rendered_matches,
        preview_path_with_position, resolve_preview_clipboard_image_src, resolve_preview_image,
