...
pub fn init(cx: &mut App) {
    ...
    zzz_actions::outline::TOGGLE_OUTLINE
        .set(|view, window, cx| {
...
pub fn toggle(
    ...
    _: &zzz_actions::outline::ToggleOutline,
    window: &mut Window,
    cx: &mut App,
) {
...
impl PickerDelegate for OutlineViewDelegate {
    ...
    fn placeholder_text(&self, _window: &mut Window, cx: &mut App) -> Arc<str> {
        tr(cx, "outline.search.placeholder", "Search buffer symbols...").into()
    }
...
pub fn render_item<T, M: IntoIterator<Item = Range<usize>>>(
    ...
    let text_style = ui::utils::buffer_text_style(cx);
...
mod tests {
    ...
    fn open_outline_view(
        ...
        cx.dispatch_action(zzz_actions::outline::ToggleOutline);
