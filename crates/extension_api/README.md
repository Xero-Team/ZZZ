# The ZZZ Rust Extension API

This crate lets you write extensions for ZZZ in Rust.
...
ZZZ extensions are packaged as WebAssembly files. In your Cargo.toml, you'll
need to set your `crate-type` accordingly:

```toml
[dependencies]
zzz_extension_api = "0.6.0"
...
To run your extension in ZZZ as you're developing it:
...
- Open the extensions view using the `zzz: extensions` action in the command palette.
- Click the `Install Dev Extension` button in the top right
- Choose the path to your extension directory.

## Compatible ZZZ versions

Extensions created using newer versions of the ZZZ extension API won't be compatible with older versions of ZZZ.

Here is the compatibility of the `zzz_extension_api` with versions of ZZZ:

| ZZZ version | `zzz_extension_api` version |
| ----------- | --------------------------- |
| `0.192.x`   | `0.0.1` - `0.6.0`           |
| `0.186.x`   | `0.0.1` - `0.5.0`           |
| `0.184.x`   | `0.0.1` - `0.4.0`           |
