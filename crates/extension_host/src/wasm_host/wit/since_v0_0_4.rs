...
impl ExtensionImports for WasmState {
    ...
    async fn latest_github_release(
        ...
        since_v0_6_0::zzz::extension::github::Host::latest_github_release(self, repo, options).await
    }

    async fn current_platform(&mut self) -> wasmtime::Result<(Os, Architecture)> {
        since_v0_6_0::zzz::extension::platform::Host::current_platform(self).await
    }
