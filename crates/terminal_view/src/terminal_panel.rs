                    ...
                    .child(
                        PopoverMenu::new("terminal-tab-bar-popover-menu")
                            .trigger_with_tooltip(
                                ...
                                Tooltip::text(tr(cx, "terminal_view.tooltip.new_menu", "New...")),
                            )
                    ...
                    .child(
                        PopoverMenu::new("terminal-pane-tab-bar-split")
                            .trigger_with_tooltip(
                                ...
                                Tooltip::text(tr(
                                    cx,
                                    "workspace.pane.tooltip.split_pane",
                                    "Split Pane",
                                )),
                            )
                            .anchor(Anchor::TopRight)
                            ...
                            .menu({
                                move |window, cx| {
                                    ContextMenu::build(window, cx, |menu, _, cx| {
                                        ...
                                        .action(
                                            tr(cx, "workspace.pane.split_right", "Split Right"),
                                            SplitRight::default().boxed_clone(),
                                        )
                                        .action(
                                            tr(cx, "workspace.pane.split_left", "Split Left"),
                                            SplitLeft::default().boxed_clone(),
                                        )
                                        .action(
                                            tr(cx, "workspace.pane.split_up", "Split Up"),
                                            SplitUp::default().boxed_clone(),
                                        )
                                        .action(
                                            tr(cx, "workspace.pane.split_down", "Split Down"),
                    ...
                    .child(SplitButton::new(
                        ButtonLike::new("open-settings-ui")
                            .child(
                                Label::new(tr(
                                    cx,
                                    "terminal_view.failed.edit_settings",
                                    "Edit Settings",
                                ))
                                .size(LabelSize::Small),
                            )
...
impl Panel for TerminalPanel {
    ...
    fn icon_tooltip(&self, _window: &Window, cx: &App) -> Option<SharedString> {
        Some(tr(cx, "menu.view.terminal_panel", "Terminal Panel").into())
    }
