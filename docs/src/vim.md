...
> **Note:** The foundations of ZZZ's vim mode should already cover many use cases, and we're always looking to improve it. If you find missing features that you rely on in your workflow, please [file an issue](https://github.com/Xero-Team/ZZZ/issues).
...
> **Note**: We don't emulate the full power of Vim's command line yet. In particular, commands currently do not support arguments. Please [file issues](https://github.com/Xero-Team/ZZZ/issues) as you find things that are missing from the command palette.
