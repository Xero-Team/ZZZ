---
title: Tab Switcher
description: "The Tab Switcher provides a quick way to navigate between open tabs in ZZZ. It displays a list of your open tabs sorted by recent usage, making it easy to ju..."
---

# Tab Switcher

The Tab Switcher provides a quick way to navigate between open tabs in ZZZ. It
...
As you navigate through the list, ZZZ will update the pane's active item to
