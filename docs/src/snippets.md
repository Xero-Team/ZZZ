---
title: Snippets - ZZZ
description: Create and use code snippets in ZZZ with tab stops, placeholders, variables, and language-scoped triggers.
---
...
The snippets are located in the `~/.config/ZZZ/snippets` directory, which you can navigate to with the {#action snippets::OpenFolder} action.
