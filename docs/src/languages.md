...
# Language Support in ZZZ

ZZZ supports hundreds of programming languages and text formats.
Some work out-of-the box and others rely on 3rd party extensions.

> The ones included out-of-the-box, natively built into ZZZ, are marked with \*.
...
- [Rust](./languages/rust.md) \* (ZZZ's written in Rust)
