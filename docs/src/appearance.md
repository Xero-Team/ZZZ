---
title: Appearance and Visual Customization - ZZZ
description: Customize ZZZ's themes, fonts, icons, UI density, and other visual settings to match your preferences.
---

# Appearance

Customize ZZZ's visual appearance to match your preferences. This guide covers themes, fonts, icons, and other visual settings.

For information on how the settings system works, see [All Settings](./reference/all-settings.md).

## Customize ZZZ in 5 Minutes

Here's how to make ZZZ feel like home:
...
That's it. You now have a personalized ZZZ setup.
...
ZZZ uses three font settings and their fallback counterparts for different contexts:
...
ZZZ provides extensive control over UI elements including:
