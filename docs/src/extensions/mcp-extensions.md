...
description: "MCP Server Extensions for ZZZ extensions."
---
...
See MCP servers published as extensions [on ZZZ's site](https://zed.dev/extensions?filter=context-servers).
