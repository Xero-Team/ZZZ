---
title: Icon Themes
description: "ZZZ comes with a built-in icon theme, with more icon themes available as extensions."
---

# Icon Themes

ZZZ comes with a built-in icon theme, with more icon themes available as extensions.
...
See: [Developing ZZZ Icon Themes](./extensions/icon-themes.md)
