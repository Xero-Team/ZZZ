---
title: Run and Test Code in ZZZ
description: Run and test code in ZZZ with Terminal, Tasks, REPL, and debugger workflows without leaving the editor.
---

# Running & Testing

Use this section to run and test code in ZZZ, then debug issues without
leaving the editor.

## What's here

- **[Terminal](./terminal.md)**: ZZZ's built-in terminal emulator. Open multiple terminals, customize your shell, and integrate with the editor. Tasks and commands run here.
...
- **[Debugger](./debugger.md)**: Set breakpoints, step through code, and inspect variables using ZZZ's built-in debugger. Works with C, C++, Go, JavaScript, Python, Rust, TypeScript, and more through the Debug Adapter Protocol.
