---
title: Roles - ZZZ
description: Understand ZZZ's organization roles and what each role can access, manage, and configure.
---

# Roles

Every member of a ZZZ organization is assigned a role that determines
...
- Disable ZZZ's collaborative features
- Control whether members can use ZZZ-hosted models and ZZZ's edit predictions
...
Members have standard access to ZZZ. They cannot access billing or
organization settings.

## Managing User Roles {#managing-users}

Owners and Admins can manage organization members from the ZZZ
...
Removing a member removes their access to organization settings and any organization-managed features. They can continue using ZZZ on their own.
