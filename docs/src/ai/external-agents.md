...
You can also add agents through your settings file ([how to edit](../configuring-zzz.md#settings-files)) by specifying certain fields under `agent_servers`, like so:
