...
Zed collects minimal data necessary to serve and improve our product. Features that could share data, like AI requests, are either opt-in or can be disabled.
