...
description: Set up AI in ZZZ with hosted models, your own API keys, or external agents. Includes how to disable AI entirely.
---
...
1. Which LLM providers you can use
   - ZZZ-hosted models, which require [authentication](../authentication.md) and [subscription](./subscription.md)
