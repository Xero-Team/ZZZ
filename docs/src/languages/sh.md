---
title: Shell Script
description: "Configure Shell Script language support in ZZZ, including language servers, formatting, and debugging."
---

# Shell Scripts

Shell Scripts (bash, zsh, dash, sh) are supported natively by ZZZ.
...
ZZZ supports auto-formatting Shell Scripts using external tools like [`shfmt`](https://github.com/mvdan/sh).
...
- [ZZZ Docs: Language Support: Bash](./bash.md)
- [ZZZ Docs: Language Support: Fish](./fish.md)
