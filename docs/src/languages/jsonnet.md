---
title: Jsonnet
description: "Configure Jsonnet language support in ZZZ, including language servers, formatting, and debugging."
---

# Jsonnet

Jsonnet language support in ZZZ is provided by the community-maintained [Jsonnet extension](https://github.com/narqo/zed-jsonnet).
