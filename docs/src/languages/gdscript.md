---
title: GDScript
description: "Configure GDScript language support in ZZZ, including language servers, formatting, and debugging."
---

# GDScript

Godot [GDScript](https://gdscript.com/) language support in ZZZ is provided by the community-maintained [GDScript extension](https://github.com/GDQuest/zed-gdscript).
...
1. Inside your Godot editor, open Editor Settings, look for `Text Editor -> External` and set the following options:
   - Exec Path: `/path/to/zzz`
   - Exec Flags: `{project} {file}:{line}:{col}`
   - Use External Editor: "✅ On"
2. Open any \*.gd file through Godot and ZZZ will launch.
