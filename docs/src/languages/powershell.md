---
title: PowerShell
description: "Configure PowerShell language support in ZZZ, including language servers, formatting, and debugging."
---

# PowerShell

PowerShell language support in ZZZ is built in and uses [PowerShell Editor Services](https://github.com/PowerShell/PowerShellEditorServices).
...
ZZZ uses the `pwsh` executable found in your path. PowerShell Editor Services is a PowerShell 7+ module, so this setup works cross-platform anywhere `pwsh` is available.

### PowerShell Editor Services {#powershell-editor-services}

ZZZ downloads [PowerShell Editor Services](https://github.com/PowerShell/PowerShellEditorServices) automatically into its language-server cache.
