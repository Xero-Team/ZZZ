---
title: Standard ML
description: "Configure Standard ML language support in ZZZ, including language servers, formatting, and debugging."
---
...
For projects with more than one source file, Millet expects a single root group file. Create a `millet.toml` in the directory you open in ZZZ:
