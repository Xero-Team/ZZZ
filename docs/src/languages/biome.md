---
title: Biome
description: "Configure Biome language support in ZZZ, including language servers, formatting, and debugging."
---

# Biome

[Biome](https://biomejs.dev/) support in ZZZ is provided by the community-maintained [Biome extension](https://github.com/biomejs/biome-zed).
...
See the [Biome ZZZ Extension README](https://github.com/biomejs/biome-zed) for a complete list of features and configuration options.
