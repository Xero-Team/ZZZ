---
title: HTML
description: "Configure HTML language support in ZZZ, including language servers, formatting, and debugging."
---
...
By default ZZZ uses [Prettier](https://prettier.io/) for formatting HTML.

Configure formatting in Settings ({#kb zzz::OpenSettings}) under Languages > HTML, or add to your settings file:
...
To use the `vscode-html-language-server` language server auto-formatting instead of Prettier, configure the formatter in Settings ({#kb zzz::OpenSettings}) under Languages > HTML, or add to your settings file:
...
You can customize various [formatting options](https://code.visualstudio.com/docs/languages/html#_formatting) for `vscode-html-language-server` via your ZZZ `settings.json`:
