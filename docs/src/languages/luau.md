---
title: Luau
description: "Configure Luau language support in ZZZ, including language servers, formatting, and debugging."
---
...
Luau language support in ZZZ is provided by the community-maintained [Luau extension](https://github.com/4teapo/zed-luau).
...
Configuration instructions are available in the [Luau ZZZ Extension README](https://github.com/4teapo/zed-luau).
