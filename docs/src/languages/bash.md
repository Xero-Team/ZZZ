---
title: Bash
description: "Configure Bash language support in ZZZ, including language servers, formatting, and debugging."
---

# Bash

Bash support is available natively in ZZZ.
...
- [ZZZ Docs: Language Support: Shell Scripts](./sh.md)
