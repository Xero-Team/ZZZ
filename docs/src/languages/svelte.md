---
title: Svelte
description: "Configure Svelte language support in ZZZ, including language servers, formatting, and debugging."
---
...
When inlay hints is enabled in ZZZ, to make the language server send them back, ZZZ sets the following initialization options:
