---
title: Erlang
description: "Configure Erlang language support in ZZZ, including language servers, formatting, and debugging."
---
...
Configure language servers in Settings ({#kb zzz::OpenSettings}) under Languages > Erlang, or add to your settings file:
