---
title: SQL
description: "Configure SQL language support in ZZZ, including language servers, formatting, and debugging."
---
...
ZZZ supports auto-formatting SQL using external tools like [`sql-formatter`](https://github.com/sql-formatter-org/sql-formatter).
...
You can add this to ZZZ project settings (`.ZZZ/settings.json`) or via your ZZZ user settings (`~/.config/ZZZ/settings.json`).
...
When using a `.sql-formatter.json` file you can use a simplified ZZZ settings configuration:
