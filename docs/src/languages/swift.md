---
title: Swift
description: "Configure Swift language support in ZZZ, including language servers, formatting, and debugging."
---

# Swift

Swift language support in ZZZ is provided by the community-maintained [Swift extension](https://github.com/zed-extensions/swift).
...
ZZZ's name for the adapter (in the UI and `debug.json`) is `Swift`, and under the hood it uses [`lldb-dap`](https://github.com/swiftlang/llvm-project/blob/next/lldb/tools/lldb-dap/README.md), as provided by the Swift toolchain.
...
[
  {
    ...
    "program": "$ZZZ_WORKTREE_ROOT/swift-app/.build/arm64-apple-macosx/debug/swift-app",
    "request": "launch",
    "adapter": "Swift"
  }
]
