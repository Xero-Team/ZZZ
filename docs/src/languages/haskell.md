---
title: Haskell
description: "Configure Haskell language support in ZZZ, including language servers, formatting, and debugging."
---
...
If you need to configure haskell-language-server (hls) you can add configuration options to your ZZZ settings.json:
