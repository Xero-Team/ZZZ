---
title: Rego
description: "Configure Rego language support in ZZZ, including language servers, formatting, and debugging."
---

# Rego

Rego language support in ZZZ is provided by the community-maintained [Rego extension](https://github.com/StyraInc/zed-rego).
