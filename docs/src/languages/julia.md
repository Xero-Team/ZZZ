---
title: Julia
description: "Configure Julia language support in ZZZ, including language servers, formatting, and debugging."
---

# Julia

Julia language support in ZZZ is provided by the community-maintained [Julia extension](https://github.com/JuliaEditorSupport/zed-julia).
