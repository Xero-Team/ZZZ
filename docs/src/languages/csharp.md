...
Roslyn is enabled by default. To switch back to OmniSharp, add the following to your ZZZ settings file:
...
OmniSharp can be configured in a ZZZ settings file with:
