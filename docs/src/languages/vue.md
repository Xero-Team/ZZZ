---
title: Vue
description: "Configure Vue language support in ZZZ, including language servers, formatting, and debugging."
---
...
`yarn dlx @yarnpkg/sdks`. In that case, you can provide the following initialization options in your ZZZ settings:
