---
title: Nim
description: "Configure Nim language support in ZZZ, including language servers, formatting, and debugging."
---

# Nim

Nim language support in ZZZ is provided by the community-maintained [Nim extension](https://github.com/foxoman/zed-nim).
