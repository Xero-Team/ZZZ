...
With that aside, we can now launch ZZZ. Given how the OCaml package manager works, we require you to run ZZZ from the terminal. See [Installation](../installation.md) for how to build from source.
