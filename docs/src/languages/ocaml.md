---
title: OCaml
description: "Configure OCaml language support in ZZZ, including language servers, formatting, and debugging."
---
...
With that aside, we can now launch ZZZ. Given how the OCaml package manager works, we require you to run ZZZ from the terminal, so please make sure you install the [ZZZ cli](https://zed.dev/features#cli) if you haven't already.
