---
title: Kotlin
description: "Configure Kotlin language support in ZZZ, including language servers, formatting, and debugging."
---

# Kotlin

Kotlin language support in ZZZ is provided by the community-maintained [Kotlin extension](https://github.com/zed-extensions/kotlin).
