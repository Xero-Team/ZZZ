---
title: PHP
description: "Configure PHP language support in ZZZ, including language servers, formatting, and debugging."
---
...
The PHP extension uses [LSP language servers](https://microsoft.github.io/language-server-protocol) with Phpactor as the default. If you want to use other language servers that support ZZZ (e.g. Intelephense or PHP Tools), make sure to follow the documentation on how to implement it.
...
Configure language servers in Settings ({#kb zzz::OpenSettings}) under Languages > PHP, or add to your settings file:
...
Check out the documentation of [PHP Tools for ZZZ](https://docs.devsense.com/other/zed/) for more details.
...
ZZZ supports syntax highlighting for PHPDoc comments.
...
- Ensure that the host and port matches between Xdebug and ZZZ.
