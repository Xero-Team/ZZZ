---
title: Elm
description: "Configure Elm language support in ZZZ, including language servers, formatting, and debugging."
---
...
ZZZ support for Elm requires installation of `elm`, `elm-format`, and `elm-review`.
