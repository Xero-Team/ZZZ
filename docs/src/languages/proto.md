---
title: Proto
description: "Configure Proto language support in ZZZ, including language servers, formatting, and debugging."
---
...
Or you can have ZZZ directly invoke `clang-format` by specifying it as a [formatter](../reference/all-settings.md#formatter) in your settings:
