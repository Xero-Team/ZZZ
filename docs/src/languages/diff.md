...
ZZZ will not attempt to format diff files and has [`remove_trailing_whitespace_on_save`](../reference/all-settings.md#remove-trailing-whitespace-on-save) and [`ensure-final-newline-on-save`](../reference/all-settings.md#ensure-final-newline-on-save) set to false.
