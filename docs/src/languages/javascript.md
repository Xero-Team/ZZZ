---
title: JavaScript
description: "Configure JavaScript language support in ZZZ, including language servers, formatting, and debugging."
---

# JavaScript

JavaScript support is available natively in ZZZ.
...
ZZZ supports JSX syntax highlighting out of the box.

In JSX strings, the [`tailwindcss-language-server`](./tailwindcss.md) is used to provide autocompletion for Tailwind CSS classes.

## JSDoc

ZZZ supports JSDoc syntax in JavaScript and TypeScript comments that match the JSDoc syntax.
ZZZ uses [tree-sitter/tree-sitter-jsdoc](https://github.com/tree-sitter/tree-sitter-jsdoc) for parsing and highlighting JSDoc.
...
ZZZ supports debugging JavaScript code out of the box with `vscode-js-debug`.
