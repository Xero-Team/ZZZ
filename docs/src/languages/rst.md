...
description: "Configure reStructuredText language support in ZZZ, including language servers, formatting, and debugging."
---

# ReStructuredText (rst)

ReStructuredText language support in ZZZ is provided by the community-maintained [reST extension](https://github.com/elmarco/zed-rst).
