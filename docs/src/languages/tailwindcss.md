---
title: Tailwind CSS
description: "Configure Tailwind CSS language support in ZZZ, including language servers, formatting, and debugging."
---

# Tailwind CSS

ZZZ has built-in support for Tailwind CSS autocomplete, linting, and hover previews.

- Language Server: [tailwindlabs/tailwindcss-intellisense](https://github.com/tailwindlabs/tailwindcss-intellisense)

Languages which can be used with Tailwind CSS in ZZZ:
...
ZZZ supports Prettier out of the box, which means that if you have the [Tailwind CSS Prettier plugin](https://github.com/tailwindlabs/prettier-plugin-tailwindcss) installed, adding it to your Prettier configuration will make it work automatically:
