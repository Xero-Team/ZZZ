---
title: Scala
description: "Configure Scala language support in ZZZ, including language servers, formatting, and debugging."
---

# Scala

Scala language support in ZZZ is provided by the community-maintained [Scala extension](https://github.com/scalameta/metals-zed).
...
<!--
TBD: Provide LSP configuration example for metals in ZZZ settings.json. metals.{javaHome,excludedPackages,customProjectRoot} etc.
-->
