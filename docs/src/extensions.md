---
title: Extensions
description: "Extend ZZZ with themes, language support, AI tools, and more through the extension system."
---

# Extensions

ZZZ lets you add new functionality using user-defined extensions.
