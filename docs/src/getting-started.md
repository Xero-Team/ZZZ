---
title: Getting Started with ZZZ
description: Get started with ZZZ, the fast open-source code editor. Essential commands, environment setup, and navigation basics.
---

# Getting Started

ZZZ is an open-source code editor with built-in AI tools.
...
When you open ZZZ without a folder, you see the welcome page in the main editor area. The welcome page offers quick actions to open a folder, clone a repository, or view documentation. Once you open a folder or file, the welcome page disappears. If you split the editor into multiple panes, the welcome page appears only in the center pane when empty—other panes show a standard empty state.
...
The command palette (`Cmd+Shift+P`) is your gateway to every action in ZZZ. If you forget a shortcut, search for it there.
...
ZZZ includes built-in support for many languages. For others, install the extension:
...
ZZZ includes built-in AI assistance. Open the Agent Panel with `Cmd+Shift+A` (macOS) or `Ctrl+Shift+A` (Linux/Windows) to start a conversation, or use `Cmd+Enter` (macOS) / `Ctrl+Enter` (Linux/Windows) for inline assistance.
...
- [IntelliJ IDEA](./migrate/intellij.md) — Adapt to ZZZ's approach to navigation and refactoring
- [PyCharm](./migrate/pycharm.md) — Set up Python development in ZZZ
- [WebStorm](./migrate/webstorm.md) — Configure JavaScript/TypeScript workflows
- [RustRover](./migrate/rustrover.md) — Rust development in ZZZ
