...
```
❌ "ZZZ is fast — really fast — and it shows in every interaction."
✅ "ZZZ is fast. You'll feel it in every interaction."
```
...
✅ "ZZZ combines editing, collaboration, and AI assistance in one workspace."
```
...
✅ "ZZZ is built for speed and collaboration."
```

### Colon-Introduced Lists in Prose

```
❌ "Three things make ZZZ different: speed, collaboration, and AI."
✅ "ZZZ prioritizes speed, real-time collaboration, and AI integration."
```
...
✅ "ZZZ renders every keystroke instantly."
```
